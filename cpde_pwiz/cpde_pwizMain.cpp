...
cpde_pwizDialog::cpde_pwizDialog(wxWindow* parent,wxWindowID id)
{
    ...
    BoxSizer6->Add(m_template_root, 1, wxEXPAND, 5);
    ...
    BrowseButton = new wxButton(this, ID_BUTTON3, _T("..."), wxDefaultPosition, wxSize(25,-1), 0, wxDefaultValidator, _T("ID_BUTTON3"));
    ...
    BoxSizer3->Add(StaticText2, 0, wxLEFT|wxRIGHT|wxALIGN_LEFT, 5);
    ...
    BoxSizer3->Add(m_project_title, 0, wxLEFT|wxRIGHT|wxEXPAND, 5);
    ...
    BoxSizer3->Add(StaticText4, 0, wxTOP|wxLEFT|wxRIGHT|wxALIGN_LEFT, 5);
    m_final = new wxStaticText(this, ID_STATICTEXT6, wxEmptyString, wxDefaultPosition, wxSize(-1,25), 0, _T("ID_STATICTEXT6"));
    wxFont m_finalFont(8,wxFONTFAMILY_SWISS,wxFONTSTYLE_NORMAL,wxFONTWEIGHT_BOLD,false,_T("Arial"),wxFONTENCODING_DEFAULT);
    m_final->SetFont(m_finalFont);
    BoxSizer3->Add(m_final, 0, wxBOTTOM|wxLEFT|wxRIGHT|wxEXPAND, 5);
    ...
    BoxSizer2->Add(ZipButton, 1, wxALL|wxALIGN_BOTTOM, 5);
