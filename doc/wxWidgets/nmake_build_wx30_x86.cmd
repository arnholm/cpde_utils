...
set MAKEFLAGS=
REM -------
nmake -f makefile.vc TARGET_CPU=x86 BUILD=release DEBUG_INFO=1 RUNTIME_LIBS=dynamic SHARED=0 
nmake -f makefile.vc TARGET_CPU=x86 BUILD=debug   DEBUG_INFO=1 RUNTIME_LIBS=dynamic SHARED=0  
REM
